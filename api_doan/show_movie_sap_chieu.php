<?php
 ...
 $query= "SELECT phim_image, phim_ten, phim_thoi_luong_id, ten_the_loai FROM tbl_phim, tbltheloai WHERE the_loai_id = id_the_loai AND trang_thai_phim = 0 ORDER BY id DESC";
